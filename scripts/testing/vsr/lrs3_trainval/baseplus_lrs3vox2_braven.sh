...
srun python raven/test.py \
    ...
    experiment_name=vsr_prelrs3vox2_baseplus_ftlrs3trainval_braven_test \
    ...
    model.pretrained_model_path=ckpts/vsr_prelrs3vox2_baseplus_ftlrs3trainval_braven.pth \