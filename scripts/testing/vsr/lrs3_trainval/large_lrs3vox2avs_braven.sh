...
srun python raven/test.py \
    ...
    experiment_name=vsr_prelrs3vox2avs_large_ftlrs3trainval_braven_test \
    ...
    model.pretrained_model_path=ckpts/vsr_prelrs3vox2avs_large_ftlrs3trainval_braven.pth \