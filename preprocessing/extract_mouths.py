...
def load_args():
    ...
    parser.add_argument('--mean_face', default='./preprocessing/20words_mean_face.npy', help='mean face path')
    parser.add_argument('--crop_width', default=96, type=int, help='width of face crop')
    parser.add_argument('--crop_height', default=96, type=int, help='height of face crop')
    parser.add_argument('--start_idx', default=48, type=int, help='start of landmark index')
    parser.add_argument('--stop_idx', default=68, type=int, help='end of landmark index')
    parser.add_argument('--window_margin', default=12, type=int, help='window margin for smoothed landmarks')
